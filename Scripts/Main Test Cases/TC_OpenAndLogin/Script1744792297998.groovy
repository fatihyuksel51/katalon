...
WebUI.waitForElementVisible(findTestObject('Object Repository/hafdii/Page_/input_Password_password'), 30)
...
WebUI.waitForElementVisible(findTestObject('Object Repository/hafdii/Page_/button_Sign in'), 30)
